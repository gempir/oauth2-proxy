...
| flag: `--skip-expired-access-token-refresh`<br/>toml: `skip_expired_access_token_refresh` | bool           | Disable automatic refresh when the access token is expired, reverting to 8.0 behaviour https://github.com/oauth2-proxy/oauth2-proxy/issues/1836                                                                                                                                       |             |
